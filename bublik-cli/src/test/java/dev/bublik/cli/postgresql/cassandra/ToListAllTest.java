...
public class ToListAllTest {
    ...
    private static JdbcDatabaseContainer<?> source = new PostgreSQLContainer<>("postgres")
            ...
            .withInitScript("./postgresql/cassandra/sql/pg-to-list-all.sql");
...
//        Thread.sleep(360_000);
        ...
        TestResult result = getResult(
                ...
                "./postgresql/cassandra/json/to-list-all.json",
                rows,
                sync,
                sourceProperties,
                targetProperties);
...
//        Thread.sleep(360_000);
    ...
    private static Long countCassandra() {
        ...
        CqlSession cqlSession = CqlSession
                ...
                .build();
        SimpleStatement stmt1 = SimpleStatement.builder("SELECT id FROM test.to_list")
