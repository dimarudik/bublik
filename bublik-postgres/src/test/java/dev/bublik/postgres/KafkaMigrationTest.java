...
public class KafkaMigrationTest {
    ...
    static void beforeAll() throws Exception {
        // Стартуем контейнеры параллельно
        postgres.start();
        kafkaContainer.start();

        // Настраиваем пул соединений для Postgres (Источник)
        ...
        // Наполняем Postgres тестовыми данными (3 строки)
