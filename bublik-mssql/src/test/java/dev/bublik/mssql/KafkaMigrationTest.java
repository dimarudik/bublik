...
public class KafkaMigrationTest {
    ...
    static final String TOPIC_NAME = "mssql-users-topic";
    ...
    static void beforeAll() throws Exception {
        ...
        try (Connection conn = sourceDataSource.getConnection(); Statement stmt = conn.createStatement()) {
            ...
            stmt.execute("INSERT INTO test.source_users (id, user_name) VALUES (1, 'Alice'), (2, 'Bob'), (3, 'Charlie')");
        }
    }
    ...
    void testMssqlToKafkaMigration() throws Exception {
        ...
        avroSchema.put("name", "MssqlUserRecord");
        ...
        assertEquals(3, kafkaMessageCount, "В топик Kafka должно приехать ровно 3 записи из MSSQL!");
    ...
    private static long countMessagesInKafka(String bootstrapServers, String topic) {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "mssql-verification-group-" + System.currentTimeMillis());
